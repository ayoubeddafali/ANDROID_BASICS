...
public class DownloadingFragment extends Fragment {
    ...
    private InterfaceBetweenActivityAndFragment mListener;
    ...
    public void changeColor(){
        //ProgressBar p = getFragmentManager()
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof InterfaceBetweenActivityAndFragment) {
            mListener = (InterfaceBetweenActivityAndFragment) context;
        } else {
